  ...
  return (
    <footer>
      ...
      <div className="bottom">
        ...
        <div className="col4">
          <form>
            <span className="email-container error">
              <input
                type="email"
                className="email"
...
// if email invalid display error message under the input
// document.querySelector(".email-container").addEventListener("keyup", (e) => {
// });

// document.querySelector(".submit-btn").addEventListener("click", (e) => {
//   e.preventDefault();
//   let emailContainer = document.querySelector(".email-container");
//   if (!emailContainer.target.value.match(/^[^\s@]+@[^\s@]+\.[^\s@]+$/)) {
//     emailContainer.target.classList.add("error");
//   } else {
//     emailContainer.target.classList.remove("error");
//   }
// });
